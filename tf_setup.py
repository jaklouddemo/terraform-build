...
print('Based on HashiCorp recommended approach "Multiple Workspaces per Repo" https://www.terraform.io/docs/cloud/workspaces/repo-structure.html')
print('')
...
print('')
print('** Create Remote Github Repos using - function using python PyGithub module')
print('')
